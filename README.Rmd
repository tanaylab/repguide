...
<!-- badges: start -->
[![Travis build status](https://travis-ci.com/tanaylab/repguide.svg?branch=master)](https://travis-ci.org/tanaylab/repguide)
<!-- badges: end -->
...
More details on the usage of Repguide is available in the package [vignette](https://tanaylab.github.io/Repguide/articles/Repguide.html). 
